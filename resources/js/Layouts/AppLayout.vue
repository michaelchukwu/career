                        ...
                        <div class="flex">
                            ...
                            <div class="flex-shrink-0 flex items-center">
                                <Link :href="route('dashboard')">
                                    ...
                                    <img src="https://nexianigeria.com/wp-content/uploads/2019/11/favicon.png" alt="" class="block h-9 w-auto">
                                </Link>
                            </div>
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <jet-nav-link :href="route('notice.index')" :active="route().current('notice.*')">
                                    Notice
                                </jet-nav-link>
                                <!--
                                <jet-nav-link :href="route('backup.index')" :active="route().current('backup.index')">
                                    BackUp
                                </jet-nav-link>
                                <jet-nav-link :href="route('backup.now')" :class="'bg-yellow-400 text-white rounded'">
                                    BackUp Now
                                </jet-nav-link> -->
